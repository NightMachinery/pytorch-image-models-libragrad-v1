...
class LayerNorm(nn.LayerNorm):
    ...
    def __init__(self, normalized_shape, eps=1e-6, affine=True):
        #: @Night corrected the name of the positional parameter to its original, `normalized_shape`
        super().__init__(normalized_shape, eps=eps, elementwise_affine=affine)

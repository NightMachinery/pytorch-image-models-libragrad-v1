...
##
#: Must be after the import above
from timm.night.decomposition import FairSiLU as SiLU
from timm.night.decomposition import GELUDecomposed as GELU
#: We use `timm.night` as using `timm.models` will create a circular import.
##
...
_ACT_LAYER_DEFAULT = dict(
    silu=SiLU if _has_silu else Swish,
    swish=SiLU if _has_silu else Swish,
...
_ACT_LAYER_ME = dict(
    silu=SiLU if _has_silu else SwishMe,
    swish=SiLU if _has_silu else SwishMe,
